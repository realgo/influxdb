...
func (bp *batchpoints) SetPrecision(p string) {
	bp.precision = p
}
...
// NewPointWithoutTime returns a point with a zero timestamp. This will be written
// to the database without a timestamp, receiving one from InfluxDB whenever
// it arrives. NOTE: It is recommended and safer to send data to the database
// with a timestamp, see NewPoint()
